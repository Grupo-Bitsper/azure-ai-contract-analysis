...
def analyze_pdf_url(sas_url: str) -> dict:
    """Sends a blob SAS URL to Document Intelligence. DI fetches the PDF from
    Azure Blob Storage server-side — zero PDF bytes loaded into Python RAM.
    Supports files up to 500MB. Falls through to the normal bytes path on error."""
