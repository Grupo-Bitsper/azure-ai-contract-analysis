...
- `codigos_inmueble`: lista de strings con cualquier código/identificador de propiedad o nave mencionado. **Ordena la lista poniendo primero los códigos internos ROCA** (patrón: 2-4 letras seguidas de 2-3 dígitos y sufijo opcional, ej: "RA03", "GU01A", "GU01-TEN", "RE05A", "CJ03B", "SL02", "SHELL-SLP02"). Después de esos, agrega otros identificadores como números catastrales, folios de registro, o claves prediales. Extrae todos los que encuentres pero respeta ese orden.
